...
public class StudentDaoImpl implements StudentDao {
    ...
    public String add(Student student) {
        ...
        try {
            List<Student> studentList = jdbcTemplate.query("SELECT * FROM student " +
                    "WHERE id=" + student.getId(), new StudentRowMapper());
    ...
    public String update(Student student) {
        ...
        try {
            int rowCount = jdbcTemplate.update("UPDATE student SET name='" + student.getName() + "'," +
                    "dept='" + student.getDept() + "',cgpa=" + student.getCgpa() + "," +
                    "email='" + student.getEmail() + "',mobile='" + student.getMobile() + "'" +
